...
// Meta Box for Slider URL
	...
	//This function adds the slide links to a metabox			
	add_action('admin_menu', 'slidelink_metabox');
	function slidelink_metabox() {
	
		global $slidelink_2_metabox;		
	
		foreach($slidelink_2_metabox['page'] as $page) {
			add_meta_box($slidelink_2_metabox['id'], $slidelink_2_metabox['title'], 'projectcharles_slidelink_metabox', $page, 'normal', 'default', $slidelink_2_metabox);
		}
	}
	
	// function to show meta boxes
	function projectcharles_slidelink_metabox()	{
		global $post;
		global $slidelink_2_metabox;
	...
	add_action('save_post', 'projectcharles_save_slidelink');
	function projectcharles_save_slidelink($post_id) {
		global $post;
		global $slidelink_2_metabox;
